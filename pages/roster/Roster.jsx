...
const Roster = (props) => {
  ...
  const deleteSelectedPlayers = () => {
    ...
    toast.current.show({ severity: 'success', summary: 'Successful', detail: 'players Deleted', life: 3000 });
  }
  ...
  const deletePlayerDialogFooter = (
    <React.Fragment>
        ...
        <Button label="Yes" icon="pi pi-check" className="p-button-text" onClick={deletePlayer} />
    </React.Fragment>
  );
  ...
  return (
  <>
   { display ? <Division division={props.division}/> : props.loading ? <div>...Loading</div> : 

    <div className={styles.container}>
      Roster for {props.division}
      ...
      <p className={styles.p}>
        ...
        <div className={styles.datatableCrudDemo}>
            ...
            <Dialog visible={deletePlayersDialog} style={{ width: '450px' }} header="Confirm" modal footer={deletePlayerDialogFooter} onHide={hideDeletePlayerDialog}>
            ...
            <Dialog visible={deletePlayersDialog} style={{ width: '450px' }} header="Confirm" modal footer={deletePlayersDialogFooter} onHide={hideDeletePlayersDialog}>
                <div className="confirmationContent">
                    <i className="pi pi-exclamation-triangle p-mr-3" style={{ fontSize: '2rem'}} />
                    {player && <span>Are you sure you want to delete the selected players?</span>}
                </div>
            </Dialog>
        </div>
        </div>
